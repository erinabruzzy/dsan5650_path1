...
abstract: |
  This study examines the effects of legalized racial discrimination in post-apartheid South Africa. Recreating the methodological framework of previous research on the effects of racial classification, we utilize data from the 2011 South African Census to evaluate labor outcomes. Specifically, we analyze income disparities among men and women across "White" and "Coloured" racial categories. Utilizing Ordinary Least Squares (OLS) regression models, we estimate the modern day returns to labor and assess the extent to which historical socioeconomic divides persist. By updating this empirical analysis with more recent census data, this project provides critical insights into the current state of economic inequality in South Africa.
---
